...
<head>
    ...
    <title>Admin Panel | Add New User | UvaLMS</title>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card card-warning">
                                ...
                                <form method="POST" action="">
                                    @csrf
                                  <div class="card-body">
                                    <p style="float:left;" class="mr-2">Last Registered User ID:</p>
                                    ...
                                    <div class="form-group">
                                        <label for="authorId">User Address</label>
                                        <textarea name="book-desc" id="useraddress" cols="30" rows="5" class="form-control" placeholder="Enter User Address" required></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="authorId">User Telephone</label>
                                        <input type="text" name="authorName" class="form-control" id="authorId" placeholder="Enter user T.P. NUmber" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="grade">Grade</label>
                                        <select name="grade" class="form-select form-control" size="3" aria-label="size 3 select example" required>
                                            <option value="000" disabled="disabled">Grades</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="class" class="form-select form-control" size="3" aria-label="size 3 select example" required>
                                            <option value="000" disabled="disabled">class</option>
